/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4cf6048da27055852b7c6ee50f42f194)
// Runtime types generated with workerd@1.20251118.0 2025-10-08 durable_object_alarms,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TaskScheduler";
	}
	interface Env {
		TASK_SCHEDULER: DurableObjectNamespace<import("./src/index").TaskScheduler>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
